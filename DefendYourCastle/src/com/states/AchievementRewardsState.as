	...
	public class AchievementRewardsState extends Sprite implements IDCState
	{
		...
		private function buildScreen():void
		{
			...
			toggle.thumbFactory = function():Button
			{
				...
				//skin the thumb here
				button.defaultSkin = new Image(Assets.bombT);
				button.downSkin = new Image(Assets.bombT);
				return button;
			}
			...
			toggle.onTrackFactory = function():Button
			{
				...
				button.defaultSkin = new Image(Assets.greenBtnT);
				button.downSkin = new Image(Assets.greenBtnT);
				return button;
			}	
