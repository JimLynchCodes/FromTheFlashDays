...
public class PluginConstants {
    ...
    public static final String ANSWER_DATA_ARY = "ada";
   
    public static final String ANSWERED_QUESTION = "aq";
    public static final String QUESTION_OVER   = "qo";
    ...
    public static final String ANSWER_TIME     = "at";
