package helpers
{
	...
	public class PlayerIoConnectAndLogin extends Sprite
	{
		private static var instance:PlayerIoConnectAndLogin;
		...
		public static function getInstance():PlayerIoConnectAndLogin {
			if (instance == null) {
				allowInstantiation = true;
				
				instance = new PlayerIoConnectAndLogin();
