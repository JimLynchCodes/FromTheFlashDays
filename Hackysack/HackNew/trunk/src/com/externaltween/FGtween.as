...
package com.externaltween {
	...
	public class FGtween {
		 ...
		 */
		public function FGtween(target:Object, duration:Number, vars:Object) {
			if (!_tnInitted) {			
...
//---- STATIC FUNCTIONS -------------------------------------------------------------------------
		 ...
		 */
		public static function to(target:Object, duration:Number, vars:Object):FGtween {
			return new FGtween(target, duration, vars);
		}
		 ...
		 * @return TweenNano instance
		 */
		public static function from(target:Object, duration:Number, vars:Object):FGtween {
		 ...
		 * @return TweenNano instance
		 */
		public static function delayedCall(delay:Number, onComplete:Function, onCompleteParams:Array=null, useFrames:Boolean=false):FGtween {
			return new FGtween(onComplete, 0, {delay:delay, onComplete:onComplete, onCompleteParams:onCompleteParams, useFrames:useFrames, overwrite:0});
		}
		...
		public static function updateAll(e:Event=null):void {
			_frame++;
			_time = getTimer() * 0.001;
			var ml:Dictionary = _masterList, a:Array, tgt:Object, i:int, t:Number, tween:FGtween;
			for (tgt in ml) {
				a = ml[tgt];
				i = a.length;
				while (--i > -1) {
