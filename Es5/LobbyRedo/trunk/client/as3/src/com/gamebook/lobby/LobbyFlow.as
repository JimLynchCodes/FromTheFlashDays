package LobbyRedo.trunk.client.as3.src.com.gamebook.lobby {
	...
	import LobbyRedo.trunk.client.as3.src.com.gamebook.dig.DigGame;
	import LobbyRedo.trunk.client.as3.src.com.gamebook.lobby.ui.ErrorScreen;
	import LobbyRedo.trunk.client.as3.src.com.gamebook.lobby.ui.LoginScreen;
	...
	public class LobbyFlow extends MovieClip{
		...
		private var _game:LobbyRedo.trunk.client.as3.src.com.gamebook.dig.DigGame;
		...
		private function showError(msg:String):void {
			var alert:LobbyRedo.trunk.client.as3.src.com.gamebook.lobby.ui.ErrorScreen = new ErrorScreen(msg);
			alert.x = 300;
			alert.y = 200;
		...
		private function createLoginScreen():void{
			var login:LobbyRedo.trunk.client.as3.src.com.gamebook.lobby.ui.LoginScreen = new LoginScreen();
